...
class House:
    def __init__(self):
        self.room = Room(101)   # Composition
...
# Ek object dusre object ka owner hota hai. Agar owner object destroy ho jaye, to uske andar wale object bhi khatam ho jate hain.
# Room ka object house pe dependent hai
